...
public class AgentCamera : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.X))
        {
            ...
            followCamera.transform.parent = Camera.main.transform;
            followCamera.transform.localPosition = new Vector3(0, 0, 0);
            followCamera.transform.localRotation = Quaternion.AngleAxis(90, Vector3.right);
        }
    }
}
